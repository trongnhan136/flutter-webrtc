...
class RTCPeerConnectionNative extends RTCPeerConnection {
  RTCPeerConnectionNative(this._peerConnectionId, this._configuration) {
    _eventSubscription =
        _eventChannelFor(_peerConnectionId).receiveBroadcastStream().listen(eventListener, onError: errorListener);
  }
  ...
  void eventListener(dynamic event) {
    ...
    switch (map['event']) {
      ...
      case 'onAddTrack':
        ...
        var newTrack = MediaStreamTrackNative(map['trackId'], track['label'], track['kind'], track['enabled']);
      ...
      case 'onRemoveTrack':
        ...
        Map<dynamic, dynamic> track = map['track'];
        var oldTrack = MediaStreamTrackNative(map['trackId'], track['label'], track['kind'], track['enabled']);
        onRemoveTrack?.call(stream, oldTrack);
        break;
      ...
      case 'onTrack':
        ...
        var transceiver = map['transceiver'] != null
            ? RTCRtpTransceiverNative.fromMap(map['transceiver'], peerConnectionId: _peerConnectionId)
            : null;
  ...
  Future<RTCSessionDescription> createOffer([Map<String, dynamic>? constraints = const {}]) async {
    try {
      final response = await _channel.invokeMethod<Map<dynamic, dynamic>>('createOffer', <String, dynamic>{
        'peerConnectionId': _peerConnectionId,
  ...
  Future<RTCSessionDescription> createAnswer([Map<String, dynamic>? constraints]) async {
    try {
      final response = await _channel.invokeMethod<Map<dynamic, dynamic>>('createAnswer', <String, dynamic>{
        'peerConnectionId': _peerConnectionId,
        'constraints': constraints ?? defaultSdpConstraints
      });
      String sdp = response!['sdp'];
  ...
  Future<RTCSessionDescription> getLocalDescription() async {
    try {
      final response = await _channel.invokeMethod<Map<dynamic, dynamic>>('getLocalDescription', <String, dynamic>{
        'peerConnectionId': _peerConnectionId,
      });
      String sdp = response!['sdp'];
      String type = response['type'];
  ...
  Future<RTCSessionDescription> getRemoteDescription() async {
    try {
      final response = await _channel.invokeMethod<Map<dynamic, dynamic>>('getRemoteDescription', <String, dynamic>{
        'peerConnectionId': _peerConnectionId,
      });
      String sdp = response!['sdp'];
      String type = response['type'];
  ...
  Future<List<StatsReport>> getStats([MediaStreamTrack? track]) async {
    try {
      final response = await _channel.invokeMethod<Map<dynamic, dynamic>>('getStats',
          <String, dynamic>{'peerConnectionId': _peerConnectionId, 'track': track != null ? track.id : null});
  ...
  Future<RTCDataChannel?> createDataChannel(String label, RTCDataChannelInit dataChannelDict) async {
    try {
      await _channel.invokeMethod<Map<dynamic, dynamic>>('createDataChannel', <String, dynamic>{
        'peerConnectionId': _peerConnectionId,
        'label': label,
  ...
  Future<List<RTCRtpSender>> getSenders() async {
    try {
      final response =
          await _channel.invokeMethod('getSenders', <String, dynamic>{'peerConnectionId': _peerConnectionId});
  ...
  Future<List<RTCRtpReceiver>> getReceivers() async {
    try {
      final response =
          await _channel.invokeMethod('getReceivers', <String, dynamic>{'peerConnectionId': _peerConnectionId});
  ...
  Future<List<RTCRtpTransceiver>> getTransceivers() async {
    try {
      final response =
          await _channel.invokeMethod('getTransceivers', <String, dynamic>{'peerConnectionId': _peerConnectionId});
  ...
  Future<bool?> removeTrack(RTCRtpSender sender) async {
    try {
      final response = await _channel.invokeMethod(
          'removeTrack', <String, dynamic>{'peerConnectionId': _peerConnectionId, 'senderId': sender.senderId});
